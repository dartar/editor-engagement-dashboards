...
$csvheaders = "['bucket', 'page_title', 'text']";
switch ($_GET['c'])
{
	case 'r':
	$c = '_r';
	$p = '?c=r';
 	$filter_c = '<h2 class="toggle"><strong>articles:</strong> <a href="?c=">[all articles]</a> [random sample] <a href="?c=a">[additional articles]</a></h2>'."\n";
	break;

	case 'a':
	$c = '_a';
	$p = '?c=a';
 	$filter_c = '<h2 class="toggle"><strong>articles:</strong><a href="?c=">[all articles]</a> <a href="?c=r">[random sample]</a> [additional articles]</h2>'."\n";
	break;

	default:
	$c = DEFAULT_FILTER_C;
	$p = '?c=';
	$filter_c = '<h2 class="toggle"><strong>articles:</strong> [all articles] <a href="?c=r">[random sample]</a> <a href="?c=a">[additional articles]</a></h2>'."\n";
	break;	
}
switch ($_GET['o'])
{
	...
	$csvheaders = "['bucket', 'page_title', 'found', 'text']";
	break;
	...
	$csvheaders = "['bucket', 'page_title', 'type', 'text']";
	break;
	...
	$csvheaders = "['bucket', 'page_title', 'rating', 'text']";
	break;
