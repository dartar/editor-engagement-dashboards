...
<p class="small">Y2Y hourly registration data: <a href="reg1_hourly_y2y.csv">csv</a><br />
Last updated: <?php echo date("Y-m-d H:i:s T", filemtime('./reg1_hourly_y2y.csv')); ?> (plot refreshed hourly)</p>
